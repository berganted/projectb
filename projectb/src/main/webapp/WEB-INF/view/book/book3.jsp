...
<body>
        ...
        $(document).ready(function () {
            ...
            $("#search").click(function () {
                ...
                .done(function (msg) {
                    console.log(msg);
                    for (var i = 0; i < 5; i++){
                        $("<div><span>제목</span><span><input type='text' id='title' name='title'value='"+ msg.documents[i].title  + "'></span>"
                        ...
                        +"<span>이미지 url</span><span><input type='text' id='thumbnail'name='thumbnail'value='"+ msg.documents[i].thumbnail  + "'></span><span><img src='" + msg.documents[i].thumbnail + "'/></span><span><input type='submit' value='저장'></span></div>").appendTo('form');
                    }
                });
            })
    ...
    <form action="bookapi.do" method="get">
